...
#
# Usage:
#   bash scripts/infer_rexgradient_full_best.sh
#   CUDA_VISIBLE_DEVICES=0 bash scripts/infer_rexgradient_full_best.sh
#   RESULT_PATH=artifacts/my_pred.jsonl bash scripts/infer_rexgradient_full_best.sh
...
LOG_FILE="${LOG_DIR}/infer_rexgradient_full_${TIMESTAMP}.log"
