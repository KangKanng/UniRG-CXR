...
#
# Usage:
#   bash scripts/infer_rexgradient_lora_best.sh
#   CUDA_VISIBLE_DEVICES=0 bash scripts/infer_rexgradient_lora_best.sh
#   RESULT_PATH=artifacts/my_pred.jsonl bash scripts/infer_rexgradient_lora_best.sh
...
LOG_FILE="${LOG_DIR}/infer_rexgradient_lora_${TIMESTAMP}.log"
